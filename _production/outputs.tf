...
output "circleci_access_key" {
  value = "${module.production_codedeploy.circleci_access_key}"
}

output "circleci_access_secret" {
  value = "${module.production_codedeploy.circleci_access_secret}"
}

output "ansible_playbooks" {
  value = "${module.production_codedeploy.ansible_playbooks}"
}
...
output "memcached_uri" {
  value = "${module.production_memcached.memcached_uri}"
}
...
output "primary_database_uri" {
  value = "datomic:ddb://${var.aws_region}/${module.production_datomic.dynamodb_table_name}/${var.primary_datomic_database}"
}
...
output "ci_bucket" {
  value = "${module.production_codedeploy.ci_bucket}"
}
